...
function MeleeVictoryDialogBJ takes player whichPlayer, boolean leftGame returns nothing
    ...
    local integer h = DzPlatform_HasGameOver_Player(whichPlayer)
    if (h==0) then
		return
    endif
...
//
function MeleeCheckLostBuilding takes unit lostUnit returns nothing
...
//
function MeleeCheckAddedBuilding takes unit addedUnit returns nothing
    local player addedUnitOwner = GetOwningPlayer(addedUnit)
    call DzEvent_Building_Start(addedUnitOwner, addedUnit)
...
//===========================================================================
function MeleeCheckFinishedBuilding takes unit finishedUnit returns nothing
    local player finishedUnitOwner = GetOwningPlayer(finishedUnit)
    call DzEvent_Building_Finish(finishedUnitOwner, finishedUnit)
endfunction

//===========================================================================
function MeleeCheckHeroDead takes unit deadHero returns nothing
    local player UnitOwner = GetOwningPlayer(deadHero)
    call DzEvent_Hero_Dead(UnitOwner, deadHero)
endfunction

//===========================================================================
function MeleeCheckUnitDead takes unit deadUnit returns nothing
    local player UnitOwner = GetOwningPlayer(deadUnit)
    call DzEvent_Unit_Dead(UnitOwner, deadUnit)
endfunction

//===========================================================================
function MeleeCheckFinishedTrainUnit takes nothing returns nothing
    local player finishUnitOwner
    local unit finishUnit
    local unit unitNode
	
    set finishUnitOwner = GetTriggerPlayer()
    set finishUnit = GetTrainedUnit()
    set unitNode = GetTriggerUnit()
    call DzEvent_Unit_Finish(finishUnitOwner, unitNode, finishUnit)
endfunction

//===========================================================================
function MeleeCheckHireUnit takes unit whichUnit returns nothing
    local player hireUnitOwner
    local unit unitNode
	
    set hireUnitOwner   = GetOwningPlayer(whichUnit)
    set unitNode   = GetSellingUnit()

    call DzEvent_Unit_Hired(hireUnitOwner, unitNode, whichUnit)
endfunction

//===========================================================================
function MeleeCheckStartTrainUnit takes integer unitType returns nothing
    local player finishUnitOwner
    local unit unitNode
	
    set finishUnitOwner = GetTriggerPlayer()
    set unitNode = GetTriggerUnit()
    call DzEvent_Unit_Start(finishUnitOwner, unitNode, unitType)
endfunction

//===========================================================================
function MeleeCheckCancelTrainUnit takes integer unitType returns nothing
    local player cancelUnitOwner
    local unit unitNode
	
    set cancelUnitOwner = GetTriggerPlayer()
    set unitNode = GetTriggerUnit()
    call DzEvent_Unit_Cancel(cancelUnitOwner, unitNode, unitType)
endfunction

//===========================================================================
function MeleeCheckStartResearchTech takes unit whichUnit returns nothing
    local player startUnitOwner
    local unit unitNode
    local integer tech
	
    set startUnitOwner = GetTriggerPlayer()
    set tech = GetResearched()
    set unitNode = GetTriggerUnit()
    call DzEvent_Tech_Start(startUnitOwner, unitNode, whichUnit, tech)
endfunction

//===========================================================================
function MeleeCheckCancelResearchTech takes unit whichUnit returns nothing
    local player cancelUnitOwner
    local unit unitNode
    local integer tech
    ...
    set tech = GetResearched()
    set unitNode = GetTriggerUnit()
    call DzEvent_Tech_Cancel(cancelUnitOwner, unitNode, whichUnit, tech)
endfunction

//===========================================================================
function MeleeCheckFinishedResearchTech takes unit whichUnit returns nothing
    local player finishUnitOwner
    local unit unitNode
    local integer tech
    ...
    set tech = GetResearched()
    set unitNode = GetTriggerUnit()
    call DzEvent_Tech_Finish(finishUnitOwner, unitNode, whichUnit, tech)
endfunction

//===========================================================================
function MeleeCheckHeroLevel takes unit whichUnit returns nothing
    local player finishUnitOwner
	
    set finishUnitOwner = GetTriggerPlayer()
    call DzEvent_Hero_Level(finishUnitOwner, whichUnit)
endfunction

//===========================================================================
function MeleeTriggerActionConstructCancel takes nothing returns nothing
    local unit unitNode = GetCancelledStructure()
    local player lostUnitOwner = GetOwningPlayer(unitNode)
    call DzEvent_Building_Cancel(lostUnitOwner, unitNode)
    call MeleeCheckLostBuilding(unitNode)
endfunction

//===========================================================================
function MeleeTriggerActionUnitDeath takes nothing returns nothing
	local unit unitNode = GetDyingUnit()
	local player lostUnitOwner = GetOwningPlayer(unitNode)
    if (IsUnitType(unitNode, UNIT_TYPE_STRUCTURE)) then
		call DzEvent_Building_Dead(lostUnitOwner, unitNode)
        call MeleeCheckLostBuilding(unitNode)
		return 
    endif
	
    if (IsUnitType(unitNode, UNIT_TYPE_HERO)) then
        call MeleeCheckHeroDead(unitNode)
		return 
    endif
	
   call MeleeCheckUnitDead(unitNode)
endfunction

//===========================================================================
function MeleeCheckUnitChangeOwner takes unit unitNode returns nothing
    local player owner
    local player preowner
	
    set preowner = GetChangingUnitPrevOwner()
    set owner = GetOwningPlayer(unitNode)
    call DzEvent_Unit_ChangeOwner(owner, preowner, unitNode)
endfunction

//===========================================================================
function MeleeCheckUnitItemDrop takes nothing returns nothing
    local player whichPlayer
    local unit whichUnit
    local item whichItem
	
    set whichPlayer = GetTriggerPlayer()
    set whichUnit = GetManipulatingUnit()
    set whichItem = GetManipulatedItem()
	
	call DzEvent_Item_Drop(whichPlayer, whichUnit, whichItem)
endfunction

//===========================================================================
function MeleeCheckUnitItemPickup takes nothing returns nothing
    local player whichPlayer
    local unit whichUnit
    local item whichItem
	...
	call DzEvent_Item_Pickup(whichPlayer, whichUnit, whichItem)
endfunction

//===========================================================================
function MeleeCheckUnitItemUse takes nothing returns nothing
    local player whichPlayer
    local unit whichUnit
    local item whichItem
	...
	call DzEvent_Item_Use(whichPlayer, whichUnit, whichItem)
endfunction

//===========================================================================
function MeleeCheckUnitItemSell takes nothing returns nothing
    local player whichPlayer
    local unit whichUnit
    local item whichItem
    ...
    set whichItem = GetSoldItem()
	
	call DzEvent_Item_Sell(whichPlayer, whichUnit, whichItem)
endfunction

//===========================================================================
function MeleeTriggerActionUnitConstructionStart takes nothing returns nothing
    call MeleeCheckAddedBuilding(GetConstructingStructure())
endfunction

//===========================================================================
function MeleeTriggerActionUnitConstructionFinish takes nothing returns nothing
    call MeleeCheckFinishedBuilding(GetConstructedStructure())
endfunction

//===========================================================================
function MeleeTriggerActionTrainFinish takes nothing returns nothing
    call MeleeCheckFinishedTrainUnit()
endfunction

//===========================================================================
function MeleeTriggerActionHireUnit takes nothing returns nothing
    call MeleeCheckHireUnit(GetSoldUnit())
endfunction

//===========================================================================
function MeleeTriggerActionTrainStart takes nothing returns nothing
    call MeleeCheckStartTrainUnit(GetTrainedUnitType())
endfunction

//===========================================================================
function MeleeTriggerActionTrainCancel takes nothing returns nothing
    call MeleeCheckCancelTrainUnit(GetTrainedUnitType())
endfunction

//===========================================================================
function MeleeTriggerActionResearchStart takes nothing returns nothing
    call MeleeCheckStartResearchTech(GetResearchingUnit())
endfunction

//===========================================================================
function MeleeTriggerActionResearchCancel takes nothing returns nothing
    call MeleeCheckCancelResearchTech(GetResearchingUnit())
endfunction

//===========================================================================
function MeleeTriggerActionResearchFinish takes nothing returns nothing
    call MeleeCheckFinishedResearchTech(GetResearchingUnit())
endfunction

//===========================================================================
function MeleeTriggerHeroLevel takes nothing returns nothing
    call MeleeCheckHeroLevel(GetLevelingUnit())
endfunction

//===========================================================================
function MeleeTriggerUnitChangeOwner takes nothing returns nothing
    call MeleeCheckUnitChangeOwner(GetChangingUnit())
endfunction

//===========================================================================
function MeleeTriggerUnitItemDrop takes nothing returns nothing
    call MeleeCheckUnitItemDrop()
endfunction

//===========================================================================
function MeleeTriggerUnitItemPickup takes nothing returns nothing
    call MeleeCheckUnitItemPickup()
endfunction

//===========================================================================
function MeleeTriggerUnitItemUse takes nothing returns nothing
    call MeleeCheckUnitItemUse()
endfunction

//===========================================================================
function MeleeTriggerUnitItemSell takes nothing returns nothing
    call MeleeCheckUnitItemSell()
endfunction
...
function MeleeInitVictoryDefeat takes nothing returns nothing
    ...
    loop
        ...
        if (GetPlayerSlotState(indexPlayer) == PLAYER_SLOT_STATE_PLAYING) then
            ...
            // Set a trigger to fire whenever a unit finished construction for this player
            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH, null)
            call TriggerAddAction(trig, function MeleeTriggerActionUnitConstructionFinish)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_TRAIN_START, null)
            call TriggerAddAction(trig, function MeleeTriggerActionTrainStart)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_TRAIN_CANCEL, null)
            call TriggerAddAction(trig, function MeleeTriggerActionTrainCancel)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_TRAIN_FINISH, null)
            call TriggerAddAction(trig, function MeleeTriggerActionTrainFinish)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_RESEARCH_START, null)
            call TriggerAddAction(trig, function MeleeTriggerActionResearchStart)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_RESEARCH_CANCEL, null)
            call TriggerAddAction(trig, function MeleeTriggerActionResearchCancel)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_RESEARCH_FINISH, null)
            call TriggerAddAction(trig, function MeleeTriggerActionResearchFinish)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_HERO_LEVEL, null)
            call TriggerAddAction(trig, function MeleeTriggerHeroLevel)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_CHANGE_OWNER, null)
            call TriggerAddAction(trig, function MeleeTriggerUnitChangeOwner)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_DROP_ITEM, null)
            call TriggerAddAction(trig, function MeleeTriggerUnitItemDrop)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_PICKUP_ITEM, null)
            call TriggerAddAction(trig, function MeleeTriggerUnitItemPickup)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_USE_ITEM, null)
            call TriggerAddAction(trig, function MeleeTriggerUnitItemUse)

            set trig = CreateTrigger()
            call TriggerRegisterPlayerUnitEvent(trig, indexPlayer, EVENT_PLAYER_UNIT_SELL_ITEM, null)
            call TriggerAddAction(trig, function MeleeTriggerUnitItemSell)
    ...
    set trig = CreateTrigger()
    call TriggerRegisterPlayerUnitEvent(trig, Player(PLAYER_NEUTRAL_PASSIVE), EVENT_PLAYER_UNIT_SELL, null)
    call TriggerAddAction(trig, function MeleeTriggerActionHireUnit)
...
//===========================================================================
function InitFinished takes nothing returns nothing
	call DzPlatform_GameStart()
endfunction
