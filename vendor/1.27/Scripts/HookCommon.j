...
//============================================================================
// Neteaese Platform API
//
native DzDebugString            takes string output returns nothing
native DzSetParams              takes string key, string value returns nothing
native DzGetPlayerName          takes integer index returns string
native DzUnitLearningSkill      takes unit whichUnit, integer skill, integer level returns nothing
native DzGetPlayerSelectedHero  takes integer index returns integer
native DzGetPlayerInitGold      takes integer index returns integer
native DzGetGameMode            takes nothing returns integer

native DzDotaInfo_Item_HE       takes integer index0, unit whichUnit returns nothing
native DzDotaInfo_Item_TM       takes integer index0, integer index1, timer whichTimer returns nothing
native DzDotaInfo_Item          takes integer index0, integer index1, integer index2 returns integer

native DzDotaInfo_IsPlayerRandom         takes integer index returns boolean
native DzDotaInfo_IsRepicked             takes integer index returns boolean

native DzEvent_Building_Dead    takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Building_Cancel  takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Building_Start   takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Building_Finish  takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Hero_Dead        takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Unit_Dead        takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Unit_Start       takes player whichPlayer, unit whichUnit, integer unitType returns nothing
native DzEvent_Unit_Cancel      takes player whichPlayer, unit whichUnit, integer unitType returns nothing
native DzEvent_Unit_Finish      takes player whichPlayer, unit whichUnit, unit whichFinishUnit returns nothing
native DzEvent_Unit_Hired       takes player whichPlayer, unit whichUnit, unit whichFinishUnit returns nothing
native DzEvent_Tech_Start       takes player whichPlayer, unit whichUnit, unit whichStartUnit, integer techID returns nothing
native DzEvent_Tech_Cancel      takes player whichPlayer, unit whichUnit, unit whichCancelUnit, integer techID returns nothing
native DzEvent_Tech_Finish      takes player whichPlayer, unit whichUnit, unit whichFinishUnit, integer techID returns nothing
native DzEvent_Hero_Level       takes player whichPlayer, unit whichUnit returns nothing
native DzEvent_Unit_ChangeOwner takes player owner, player preowner, unit unitNode returns nothing
native DzEvent_Item_Drop        takes player whichPlayer, unit whichUnit, item whichItem returns nothing
native DzEvent_Item_Pickup      takes player whichPlayer, unit whichUnit, item whichItem returns nothing
native DzEvent_Item_Use         takes player whichPlayer, unit whichUnit, item whichItem returns nothing
native DzEvent_Item_Sell        takes player whichPlayer, unit whichUnit, item whichItem returns nothing

native DzPlatform_GameStart             takes nothing returns nothing
native DzPlatform_HasGameOver           takes nothing returns integer
native DzPlatform_HasGameOver_Player    takes player whichPlayer returns integer
