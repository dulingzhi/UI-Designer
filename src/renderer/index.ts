...
export { getFrameTypeColor, FRAME_TYPE_COLORS, DEFAULT_FRAME_COLOR, EGxMatAlphaOp, ALPHA_REF, EDGE_UV_STRIPS, CORNER_POSITION_FACTOR, EDGE_FLAGS, FILTER_MODES } from './constants';
